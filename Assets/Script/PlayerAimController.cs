...
public class PlayerAimController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isRightClickPressed)
        {
            ...
            if (player.currentEquipment == Player.EquipmentType.Gun && player.bulletCount > 0)
            {
                if (animator != null)
                {
        ...
        {
            if (player.currentEquipment == Player.EquipmentType.Gun && cooldownTimerBullet <= 0 && player.bulletCount > 0)
            {
            ...
            else if (player.currentEquipment == Player.EquipmentType.Coin && cooldownTimerCoin <= 0 && player.coinCount > 0)
            {
